          ...
          {EVENT_TYPES.map((event) => (
            ...
            >
              ...
              <div className="absolute bottom-0 p-4 xs:p-5 md:p-6">
                ...
                <h3 className="font-display text-lg xs:text-xl font-semibold text-white">{event.title}</h3>
                <p className="text-xs xs:text-sm text-white/70 mt-2 leading-relaxed line-clamp-3 xs:line-clamp-none">
                  {event.desc}
                </p>
              </div>
            </motion.div>
