    ...
    <section id="support" className="section-padding bg-dark-soft overflow-hidden">
      <div className="section-container">
        ...
        >
          ...
          <div className="absolute inset-0 glass-card rounded-2xl sm2:rounded-3xl border-border" />
            ...
            >
              {SUPPORT_ACTIONS.map((action) => (
                <motion.a
                  ...
                  className="group flex flex-col items-center text-center p-5 rounded-2xl bg-white border border-border hover:border-secondary/40 hover:bg-white hover:shadow-[0_12px_40px_rgba(198,138,31,0.06)] hover:-translate-y-1.5 transition-all duration-300 min-w-0"
                >
