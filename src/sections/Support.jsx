...
import { Headphones, Phone, Mail, MessageSquare, Clock } from 'lucide-react';
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            <motion.div variants={fadeInUp}>
              ...
              <p className="mt-4 text-cream/60 leading-relaxed max-w-md">
                Our dedicated guest relations team is available around the clock to ensure your
            ...
            >
              {SUPPORT_ACTIONS.map((action) => (
                <motion.a
                  ...
                  variants={fadeInUp}
                  href={action.href}
                  target={action.label === 'Live Chat' ? '_blank' : undefined}
                  rel={action.label === 'Live Chat' ? 'noopener noreferrer' : undefined}
                  whileHover={{ y: -4 }}
